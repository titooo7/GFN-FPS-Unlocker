...
import soy_titooo.xposed.gfnfpsunlocker.Constants.PREF_OVERRIDE_ROM_FEATURE_LEVELS
...
class FeatureSpoofer : IXposedHookLoadPackage {
    ...
    /**
     * If a feature needed for GeForce NOW is needed, i.e. features in [finalFeaturesToSpoof],
